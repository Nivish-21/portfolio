...
export function DeltaPanel({ project }: { project: Project }) {
  ...
  return (
    ...
    >
      ...
      <h3 className="font-display font-bold uppercase text-lg tracking-[0.02em] mb-1 pr-14 min-h-14 line-clamp-2">
        {project.name}
      </h3>
      <p className="text-sm text-muted max-w-[46ch] mb-4 min-h-[100px] line-clamp-5">{project.summary}</p>
        ...
        <dl className="flex flex-col gap-0">
            ...
            <dd>
              <div className="h-2 rounded-[1px] bg-ink/10 relative overflow-hidden">
                <span
                  ...
                  style={{ width: filled ? "46%" : "0%", transitionTimingFunction: "cubic-bezier(0.34, 1.56, 0.64, 1)" }}
                />
              </div>
            </dd>
            <dd className="text-yellow font-semibold min-h-8 line-clamp-2">{project.baseline}</dd>
          </div>
          <div className="grid grid-cols-[80px_96px_1fr] items-center gap-3 py-1.5 border-t border-dashed border-line-strong font-mono text-xs">
            ...
            <dd>
              <div className="h-2 rounded-[1px] bg-ink/10 relative overflow-hidden">
                <span
                  ...
                  style={{ width: filled ? "92%" : "0%", transitionTimingFunction: "cubic-bezier(0.34, 1.56, 0.64, 1)" }}
                />
              </div>
            </dd>
            <dd className="text-green font-semibold min-h-8 line-clamp-2">{project.optimised}</dd>
          </div>
          <div className="grid grid-cols-[80px_1fr_auto] items-center gap-3 py-1.5 border-t border-dashed border-line-strong font-mono text-xs">
            ...
            <dd
              ...
              style={TONE_GLOW[project.resultTone] ? { textShadow: TONE_GLOW[project.resultTone] } : undefined}
            >
